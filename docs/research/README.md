...
| [`systems/dynamic-political-simulation.md`](systems/dynamic-political-simulation.md) | Evidence boundary for coupled faction, Crown, constituency, credential, and chamber-vote reducers |
