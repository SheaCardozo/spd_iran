# Research bibliography and source trust registry

This is the running registry for sources actually used by the game and for
high-priority works guiding future research. An entry is not an endorsement of
every conclusion in a work. Trust notes explain why the source is useful and
where it requires comparison.

The complete review of the design bibliography is in
[`SOURCE_AUDIT.md`](SOURCE_AUDIT.md). Respected works whose relevant text is not
presently accessible are tracked in
[`UNAVAILABLE_SOURCES.md`](UNAVAILABLE_SOURCES.md). A source being **Core**
does not authorize a historical claim until the relevant text has been read
and a precise locator recorded beside that claim.

Files actually held by the project are cataloged in
[`AVAILABLE_SOURCES.md`](AVAILABLE_SOURCES.md). Thus the bibliography explains
why a source is trusted and how it is used, while the available/unavailable
catalogs state whether the evidence itself can currently be inspected.

## Status key

- **Used** — supports an implemented claim or representation.
- **Core** — expertise and scholarly standing are approved for a principal
  foundation; access and claim-level locators are still required.
- **Supplement** — approved for a focused question or interpretive comparison,
  normally alongside book-length scholarship or primary evidence.
- **Candidate** — relevant, but access, edition, expertise, or fit still needs
  review.

## Used sources

<a id="sup-001"></a>
### SUP-001 — Mari Nukii, “Protest Events in the Tehran Bazaar during the Oil Nationalization Movement of Iran”

- **Status:** Used.
- **Archive:** [`SUP-001` available-source record](AVAILABLE_SOURCES.md#sup-001);
  local supplemental PDF and metadata under
  `docs/research/sources/supplemental/`.
- **Publication:** *Annals of Japan Association for Middle East Studies* 28,
  no. 1 (2012), pp. 1–34.
- **Stable identifier:** <https://doi.org/10.24498/ajames.28.1_1>
- **Access:** Full article reviewed; p. 10 is the current claim locator.
- **Author expertise and standing:** Nukii is a researcher of modern Iranian
  politics and the Tehran bazaar. This peer-reviewed specialist article uses a
  systematic event dataset constructed from the Persian newspapers
  *Eṭṭelāʿāt* and *Bākhtar-e Emrūz* and engages the major scholarship on bazaar
  politics.
- **Evidence and languages:** Persian press material and English-language
  scholarship; the article is in English.
- **Trust and limitations:** Strong for its narrow subject—organization and
...
## Acquired Persian primary editions

These are sources for what participants and organizations wrote, remembered,
or claimed. Their acquisition does not make their assertions independently
true.

<a id="sup-002"></a>
### SUP-002 — Mohammad Mossadegh, *Khaterat va Ta'alomat-e Doktor Mohammad Mossadegh*

- **Status:** Acquired primary source; not yet used.
- **Access:** [`SUP-002` available-source record](AVAILABLE_SOURCES.md#sup-002).
- **Persian title:** خاطرات و تألمات دکتر محمد مصدق.
- **Editorial history:** The established edition was prepared by bibliographer
  and historian Iraj Afshar with an introduction by Gholam-Hossein Mossadegh.
  The local scan does not establish which printing it reproduces.
- **Trust and limitations:** Essential for Mossadegh's retrospective voice and
  self-understanding, but memoir is selective and interested evidence. Compare
  factual and causal claims with dated proceedings, correspondence, press, and
  scholarship.
- **Planned use:** Constitutional arguments, oil policy, and character voice.

<a id="sup-003"></a>
### SUP-003 — Masoud Kuhestani-Nejad, ed., *Hezb-e Iran: Majmu'e-i az Asnad va Bayaniyeha, 1323–1332*

- **Status:** Acquired edited primary collection; not yet used.
- **Access:** [`SUP-003` available-source record](AVAILABLE_SOURCES.md#sup-003).
- **Persian title:** حزب ایران: مجموعه‌ای از اسناد و بیانیه‌ها، ۱۳۲۳–۱۳۳۲.
- **Publication:** Tehran: Mo'asseseh-ye Nashr va Pazhuhesh-e Shirazeh, 1379
  SH / 2000–01.
- **Editor expertise and standing:** Kuhestani-Nejad is an editor and historian
  of modern Iranian political documents. This identified scholarly edition is
  materially stronger than an anonymous web transcription because it presents
  a cataloged corpus with dates and editorial organization.
- **Trust and limitations:** Party documents authoritatively establish issued
  positions, not the truth of party accusations or the private motives of all
  members. Cite the individual document and editorial locator.
- **Planned use:** Iran Party organization, National Front coalition policy,
  statements, and factional change.

<a id="sup-004"></a>
### SUP-004 — Homa Katouzian and Amir Pishdad, eds., *Namehha-ye Khalil Maleki*

- **Status:** Acquired edited primary collection; not yet used.
- **Access:** [`SUP-004` available-source record](AVAILABLE_SOURCES.md#sup-004).
- **Persian title:** نامه‌های خلیل ملکی.
- **Publication:** Tehran: Nashr-e Markaz, 1381 SH / 2002–03.
- **Editor expertise and standing:** Katouzian is an established historian of
  Iran and specialist on Maleki; Pishdad was a correspondent of Maleki and
  contributes direct provenance. The named editors and reputable publisher
  make this preferable to detached quotations on political sites.
- **Trust and limitations:** Letters are situated communications whose audience
  and date matter. Distinguish the original letter from editorial annotation
  and compare retrospective or accusatory statements.
- **Planned use:** Maleki, Third Force, Toilers Party, intellectual networks,
  and coalition fracture.

<a id="sup-005"></a>
### SUP-005 — Karim Sanjabi, *Omidha va Naomidiha*

- **Status:** Acquired primary memoir; not yet used.
- **Access:** [`SUP-005` available-source record](AVAILABLE_SOURCES.md#sup-005).
- **Persian title:** امیدها و ناامیدی‌ها: خاطرات سیاسی دکتر کریم سنجابی.
- **Publication:** London: Entesharat-e Jebhe-ye Melliun-e Iran, 1368 SH /
  1989–90.
- **Author standing:** Sanjabi was a senior Iran Party and National Front
  participant, making him an important witness rather than a detached expert
  narrator.
- **Trust and limitations:** The account is retrospective and was published by
  a National Front body. Use it to establish Sanjabi's testimony and compare it
  with contemporary party documents, proceedings, and other witnesses.
...
<a id="sup-006"></a>
### SUP-006 — *Majmu'e-ye Qavanin-e Dowreh-ye Shanzdahom-e Qanungozari*

- **Status:** Acquired official publication; nine-article law locator verified.
- **Access:** [`SUP-006` available-source record](AVAILABLE_SOURCES.md#sup-006).
- **Issuing authority:** Majles-e Shura-ye Melli, Majles Printing House.
- **Trust and limitations:** Authoritative for the enacted text and the
  compilation's record of approval, not for the motives or effects of the law.
  Cite the individual article and printed page.
- **Verified use:** Oil-nationalization implementation law, printed pp. 15–16
  (PDF images 27–28).

<a id="sup-007"></a>
### SUP-007 — Sixteenth and Seventeenth Majles proceedings

- **Status:** Acquired complete session-file corpus as enumerated by the host.
- **Access:** [`SUP-007` available-source record](AVAILABLE_SOURCES.md#sup-007).
- **Issuing authority:** Majles-e Shura-ye Melli.
- **Trust and limitations:** The proceedings are direct evidence of recorded
...
- **Verified use:** The six-month emergency-powers bill was passed by a
  ...
  tally. For the Sixteenth Majles, sessions 2, 3, 5, 6, 7, 8, 25, 30, and 69
  establish the first credential waves through the Tehran intake and the
  late southern-Armenian return; session 128 records all representatives present
  rising for the nationalization report; and session 141 records all present
  rising for the aggregate nine-article implementation bill after
  article-by-article standing votes. The two oil sessions print no numerical
  tally.
...
- **Status:** Partial corpus acquired.
- **Access:** [`SUP-011` available-source record](AVAILABLE_SOURCES.md#sup-011).
- **Editor expertise and standing:** Chaqueri was a historian of Iranian
  socialism and communism whose long-running documentary project assembled
  otherwise dispersed multilingual movement records. The collection is
  valuable because of that archival labor, not because its selection or
  framing is neutral.
- **Trust and limitations:** The individual records are situated primary
  evidence. The local 2025 volumes 1–6 are new, movement-affiliated
  transcriptions with acknowledged textual normalization, while legacy scans
...
- **Author expertise and standing:** Azimi is a historian specializing in
  ...
  includes extensive scholarship in Persian. His university profile records
  specialist work on Iranian elections and British influence as well as awards
  from the International Society for Iranian Studies:
  <https://history.uconn.edu/person/fakhreddin-azimi/>. This monograph is a
  major scholarly study of parties, cabinets, elections, the court, parliament,
  and the erosion of Iran's democratic opening.
...
- **Author expertise and standing:** Abrahamian is a leading historian of
  ...
  Center. His institutional profile lists a sustained body of university-press
  books on modern Iranian political and social history and his election to the
  American Academy of Arts and Sciences:
  <https://weissman.baruch.cuny.edu/weissman-academic-departments/the-department-of-history/department-of-history-faculty/ervand-abrahamian/>.
  His work draws on Persian-language political publications and extensive party
...
- **Status:** Used; Core. Other chapters still require their own author and
  locator records.
...
- **Editor expertise and standing:** Gasiorowski is a long-standing specialist
  ...
  <https://news.tulane.edu/experts/profile/mark-gasiorowski>. Byrne is a
  historian and archival researcher associated with the National Security
  Archive. The volume brings together specialists with differing emphases.
- **Trust and limitations:** Valuable precisely because it is not a single
  verdict. Individual chapters must be cited to their own authors rather than
  attributing all claims to the editors.
- **Project use:** Behrooz's Tudeh chapter, pp. 102–25, and Gasiorowski's coup
  chapter, pp. 227–80, in the historical primer and crisis audit. Other
  chapters remain uncited until individually reviewed.
...
- **Author expertise and standing:** Rahnema is a scholar of modern Iranian
  ...
  modern Iranian history and the interaction of politics, economics, and
  religion: <https://graduate.aup.edu/ali-rahnema>. This specialist
  reconstruction uses Iranian, British, and American evidence to examine the
  actors and sequence of 15–19 August.
...
- **Status:** Used as a Core interpretive comparison.
...
- **Author expertise and standing:** Katouzian is an economist, historian, and
  ...
  Iranian political economy, literature, and state–society relations:
  <https://www.bloomsbury.com/ca/author/homa-katouzian/>.
...
- **Project use:** Negotiation and coalition-fracture interpretation in the
  historical primer, using the revised preface and chapters 8–9 and 11–12.
  Quotations still require verification against the original page images.

<a id="s7"></a>
### S7 / MAJ-S7 — Darioush Bayandor, *Iran and the CIA: The Fall of Mosaddeq Revisited*

- **Status:** Used as a Core counterpoint.
...
- **Author expertise and standing:** Bayandor is an Iran analyst, historian,
  ...
  presents the book as a source-based reassessment:
  <https://link.springer.com/book/10.1057/9780230277304>.
- **Trust and limitations:** A serious revisionist challenge emphasizing
  Iranian domestic agency and questioning how decisively the CIA operation
  explains 19 August. It belongs in the comparison set, not as the neutral
  default; test its claims against declassified operational records and other
  specialist histories.
- **Project use:** Chapters 7–9 as an explicit revisionist counterpoint in the
  primer's coup interpretation, compared with operational records and other
  specialist histories.

## Reviewed focused scholarship

These sources are approved for the stated narrow roles. They do not replace the
core books. Full bibliographic annotations remain in `docs/GAME_DESIGN.md`;
the audit decisions are in `SOURCE_AUDIT.md`.
...
| E10 | Homa Katouzian, *The Political Economy of Modern Iran: Despotism and Pseudo-Modernism, 1926–1979* (Macmillan, 1981) | Core book-length interpretation by an established Iranian economist and historian. Particularly important for fiscal politics, note cover, and the oil-less economy; its broader state/society framework requires comparison with other specialists and primary data. | **Acquired:** complete 1981 first-edition scan as [`MAJ-S16`](AVAILABLE_SOURCES.md#maj-s16), with searchable text and stable print pagination. Prioritize pp. 141–210 and notes during the economic review. |
| E11 | Julian Bharier, *Economic Development in Iran, 1900–1970* (Oxford University Press, 1971) | Foundational book-length economic synthesis by an Iran economist who later served as a World Bank senior economist. Its extensive data/source compilation is indispensable, while early national-income estimates and inherited official definitions require audit. | **Acquired:** complete OUP edition as [`MAJ-S17`](AVAILABLE_SOURCES.md#maj-s17), including tables, bibliography pp. 283–303, and index. Treat its reconstructed series as evidence to audit, not ready-made mechanics. |
| E12 | Gregory Brew, *Petroleum and Progress in Iran: Oil, Development, and the Cold War* (Cambridge University Press, 2022) | Recent university-press monograph by a specialist historian of oil, Iran, and the Cold War using Iranian and US material. Best modern interpretive check on petroleum, development, and the 1952 oil-less program. | **Acquired and partially used:** complete searchable CUP edition as [`MAJ-S18`](AVAILABLE_SOURCES.md#maj-s18), DOI `10.1017/9781009206327`. Chapter 4, pp. 120–44, is reviewed and cited for oil-less economics, Point Four, the collapse narrative, and the pre-coup assessment; the remainder still requires claim-level review. |
...
These exact books recur across the acquired core bibliographies and the
bibliographies of specialist Iranica entries. Acquisition status is recorded
below; presence does not turn an unread work into claim-level evidence.

| ID | Source | Why it is trusted and wanted | Discovery cross-check |
| --- | --- | --- | --- |
| S14 | James A. Bill and Wm. Roger Louis, eds., *Musaddiq, Iranian Nationalism, and Oil* (University of Texas Press, 1988) | Scholarly edited volume by established diplomatic- and Iranian-history specialists; useful for multiple national and archival perspectives. Cite chapters individually. | **Acquired:** [`MAJ-S11`](AVAILABLE_SOURCES.md#maj-s11), complete first University of Texas Press edition. An earlier mislabeled duplicate remains separately documented. |
| S15 | Richard W. Cottam, *Nationalism in Iran*, updated ed. (University of Pittsburgh Press, 1979) | Major scholarly study by an Iran specialist with direct diplomatic experience; important but shaped by Cold War-era categories and requiring later comparison. | **Acquired:** [`MAJ-S8`](AVAILABLE_SOURCES.md#maj-s8) now contains the preferred 1979 updated edition and the retained 1964 predecessor. |
| S16 | Habib Ladjevardi, *Labor Unions and Autocracy in Iran* (Syracuse University Press, 1985) | Book-length specialist labor history by the director of the Harvard Iranian Oral History Project; high value for union organization and state–labor relations. | **Acquired and used:** [`MAJ-S9`](AVAILABLE_SOURCES.md#maj-s9), complete first-edition scan with stable print pagination and a separate English OCR derivative. Used for the exact 4 February 1949 attempt and immediate Tudeh suppression at printed pp. 90–92, labor/Abadan chapters 3–4, and the pre-shutdown strike at printed pp. 188–92. |
| S17 | Mohammad Ali Movahed, *Khab-e Ashofteh-ye Naft*, 2 vols. (Karnameh, 1378 SH / 1999–2000) | Extensive Persian oil history by a distinguished Iranian legal scholar and historian; valuable for legal texts and Iranian debates. Interpretive claims still need comparison. | **Partially acquired:** [`MAJ-S10`](AVAILABLE_SOURCES.md#maj-s10) is volume II, revised second edition, winter 1384 SH. Volume I remains wanted. |
...
- **Access:** [`SUP-025` available-source
  record](AVAILABLE_SOURCES.md#sup-025); the completed acquisition and edition
  audit is retained in [`SOURCE_AUDIT.md`](SOURCE_AUDIT.md#official-record-and-newspaper-acquisition).
...
- **P2:** approved and acquired as the official Department of State EPUB,
  [`SUP-016`](AVAILABLE_SOURCES.md#sup-016). Document 273 and its stable
  electronic section were verified.
- **P3:** approved and acquired as the complete ICJ judgment and opinions in
...
- **P7:** approved and acquired as official historic Hansard,
  [`SUP-021`](AVAILABLE_SOURCES.md#sup-021). Its English rendering does not
  replace the Persian legal text in `SUP-006`.
- **P8:** approved and acquired as two declassified CIA internal histories,
  [`SUP-022`](AVAILABLE_SOURCES.md#sup-022). Treat them as interested
...
## Discovery repositories and provenance rules

| Discovery ID | Resource | Proper use | Limitation |
| --- | --- | --- | --- |
| D1 | [Iran Archive](https://www.iran-archive.com/fa) | Locate scans of Persian books, periodicals, party publications, oral histories, and document compilations; record both catalog page and direct file. | The repository says that some state-security releases and typed copies have not been checked against originals. Its catalog prose is not evidence, and each file needs edition and provenance inspection. |
| D2 | [Mashruteh](https://mashruteh.org/wiki/index.php/) | Locate typed Majles debates, laws, and newspaper scans, then resolve them to official Majles printings or period issues. One immediate lead is the nine-point implementation law in *Majmu'e-ye Qavanin-e Dowreh-ye 16*, Majles Press, pp. 15–16. | Monarchist framing and web transcription are not authorities. Do not cite the site's narrative or silently substitute typed text for the official printed record. |
| D3 | [Encyclopaedia Iranica](https://www.iranicaonline.org/) | Use named specialist articles as bibliographic maps and terminology checks; record the article author and pursue cited scholarship and primary evidence. | Never use an Iranica entry directly as an implemented event source. Some older entries also reflect the scholarship and available records of their publication date. |
